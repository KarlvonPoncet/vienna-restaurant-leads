...
(() => {
  ...
  function addDetailValue(list, label, value) { const item = el("div", "detail-item"); item.append(el("dt", null, label), el("dd", null, value || "Not recorded")); list.appendChild(item); }
